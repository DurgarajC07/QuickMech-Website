...
?>
    <div class="container">
        <h1 align='center'>A/C Service Form</h1>
    </div>


      <form action="{{ url('add-acService') }}" method="POST" accept-charset="UTF-8">
          {{csrf_field()}}
      <div class="modal-body">
                <div class="mb-3">
                    <h3>This services is only available for Cars.</h3>
                </div>
                <div class="mb-3">
