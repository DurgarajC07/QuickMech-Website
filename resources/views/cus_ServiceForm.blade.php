...
<body>
    <div class="container">
        <h1 align='center'>Custom Service Form</h1>
    </div>


      <form action="{{ url('add-customService') }}" method="POST" accept-charset="UTF-8">
          {{csrf_field()}}
      <div class="modal-body">
               ...
               <label >Choose Service:</label>
                ...
                <option value="CLUTCH & TRANSMISSION SERVICES">CLUTCH & TRANSMISSION SERVICES</option>
                <option value="HEAD/ENGINE SERVICE">HEAD/ENGINE SERVICE</option>
                <option value="SUSPENSION SERVICE">SUSPENSION SERVICE</option>
                <option value="BATTERIES">BATTERIES</option>
                <option value="TYRES & WHEEL">TYRES & WHEEL</option>
